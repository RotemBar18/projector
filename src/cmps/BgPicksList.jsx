...
export function BgPicksList({ bgPicks, onChangeBg }) {
    ...
    return (
        <div className='picks'>
            <div className='pick 1' onClick={() => onChangeBg(pick, '../assets/simgs/photosPreview.jpg', '#61bd4f')} style={(pick === 'photos') ? { backgroundImage: `url(../assets/imgs/photosPreview.jpg)` } : { backgroundColor: '#61bd4f' }}></div >
